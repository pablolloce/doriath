...
export const LAYERS = Object.freeze({
  ...
  "work-plan": { axis: "work", prefix: "WRK-PLAN", folder: ["specs", "work", "work-plan"], label: "Feature", sections: ["Approach", "Task Breakdown"] },
  "work-task": { axis: "work", prefix: "WRK-TASK", folder: ["specs", "work", "work-task"], label: "Historia de usuario", sections: ["Objective", "Acceptance Criteria"] },
